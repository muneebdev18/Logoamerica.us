...
export const PROJECTS: Project[] = [
  ...
  //   year: "2025",
  //   scope: ["Full Rebrand", "Symbol Design", "Identity System", "Guidelines"],
  //   result: "+180%",
  //   resultLabel: "Brand recognition increase post-launch",
  //   asset: { type: "image", src: "/P7.jpeg" },
  //   accent: "#1e3a5f",
  // },
  // {
  ...
  //   year: "2024",
  //   scope: ["Wordmark", "Visual Identity", "Digital Assets", "Stationery"],
  //   result: "4.9/5",
  //   resultLabel: "Client satisfaction score across portfolio",
  //   asset: { type: "image", src: "/P8.jpeg" },
  //   accent: "#c41e3a",
  // },
  // {
  ...
  //   year: "2024",
  //   scope: ["Symbol Design", "Accessible Color System", "Motion Logo", "App Icons"],
  //   result: "WCAG AA",
  //   resultLabel: "Full accessibility compliance achieved",
  //   asset: { type: "image", src: "/P9.jpeg" },
  //   accent: "#006d77",
  // },
  // {
  ...
  //   year: "2025",
  //   scope: ["Wordmark", "Fleet Branding", "Environmental Graphics", "Guidelines"],
  //   result: "50+",
  //   resultLabel: "Vehicles branded across 12 states",
  //   asset: { type: "image", src: "/P10.jpeg" },
  //   accent: "#e85d04",
  // },
];
