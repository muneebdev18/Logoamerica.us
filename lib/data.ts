...
export const SERVICES: Service[] = [
  {
    index: "01",
    title: "Logo Design",
    body: "The mark itself — wordmarks, symbols, and monograms drawn to survive everything from an app icon to a highway billboard.",
    tags: ["Wordmarks", "Symbols", "Monograms"],
  },
  {
    index: "02",
    title: "Identity Systems",
    body: "Color, type, grid, and pattern — the rules that make one logo behave like a hundred coordinated decisions.",
    tags: ["Color systems", "Typography", "Art direction"],
  },
  {
    index: "03",
    title: "Rebrands",
    body: "Evolution without identity loss. We audit your equity, keep what works, and rebuild what doesn't — without alienating the customers you already earned.",
    tags: ["Brand audits", "Rollouts", "Legacy brands"],
  },
  {
    index: "04",
    title: "Naming & Verbal",
    body: "Names that clear trademark, taglines that stick, and a voice your support team can actually write in.",
    tags: ["Name development", "Taglines", "Voice & tone"],
  },
  {
    index: "05",
    title: "Motion & Responsive",
    body: "Marks that move and adapt — animated logos, responsive icon suites, and app icons tuned pixel by pixel.",
    tags: ["Logo animation", "App icons", "Favicon suites"],
  },
  {
    index: "06",
    title: "Brand Guidelines",
    body: "Guideline books your team opens on Mondays — practical, illustrated, and built for people who aren't designers.",
